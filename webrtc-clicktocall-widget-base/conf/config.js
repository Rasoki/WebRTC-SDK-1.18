let c2c_serverConfig = {
    domain: 'example.com',                 // SBC domain name, used to build SIP headers From/To
    addresses: ['wss://example.sbc.com'],  // AudioCodes SBC secure web socket address (can be multiple)
...
let c2c_config = {
    // Call
    call: 'John Doe', // Call to this user name (or phone number). Special value: '_take_value_from_url_' to set the value from URL 'call' parameter
