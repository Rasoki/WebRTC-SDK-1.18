            ...
            if (token) {
                ...
                if (kc.timeSkew != null) {
                    ...
                    if (kc.onTokenExpired) {
                        ...
                        // Igor's fix: call onTokenExpired  a little before expiration time.
                        var graceTime = (10 + Math.floor(Math.random() * 11)) * 1000; // 10 000 .. 20 000 ms
                        expiresIn = expiresIn - graceTime;
                        if (expiresIn <= 0) {
                            kc.onTokenExpired();
                        } else {
            ...
            if (!type || type == 'default') {
                return {
                    login: function(options) {
                        ...
                        console.log('[login] assignement location.href:' + window.location.href);
                        return createPromise().promise;
                    },

                    logout: function(options) {
                        window.location.href = kc.createLogoutUrl(options);
                        console.log('[logout] assignement location.href:' + window.location.href);
                        return createPromise().promise;
                    },

                    register: function(options) {
                        window.location.href = kc.createRegisterUrl(options);
                        console.log('[register] assignement location.href:' + window.location.href);
                        return createPromise().promise;
                    },
                    ...
                    accountManagement: function() {
                        ...
                        if (typeof accountUrl !== 'undefined') {
                            ...
                            console.log('[accountManagement] assignement location.href:' + window.location.href);
                        } else {
                            throw "Not supported by the OIDC server";
                        }
                        return createPromise().promise;
