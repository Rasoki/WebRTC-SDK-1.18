...
let DefaultPhoneConfig = {
    ...
    addLoggerTimestamp: true, // Add timestamp string to log.
    ...
    // SDK modes and fixes.
    modes: {
        ice_timeout_fix: 500,             // ICE gathering timeout (milliseconds)
...
let DefaultUserPref = {
    ...
    videoSize: 'Small', // Micro, X Tiny, Tiny, X Small, Small, Medium, X Medium, Large, X Large, XX Large, Huge, Default
